    ...
    <div class="row">
      <div class="col-md-7">
        <div class="alert alert-info">
          <p>
            Silahkan lakukan pembayaran Rp. <?= number_format($detail['total_pembelian']); ?>,- Pilih Salah Satu Saja <br>
            <strong>BANK BCA 7285400104 AN Yoshua Nicolas Manalu</strong><br>
            <strong>BANK MANDIRI 123-111-111 AN Asal Koding</strong><br>
            <strong>BANK MANDIRI 123-111-111 AN Asal Koding</strong><br>
            <strong>BANK MANDIRI 123-111-111 AN Asal Koding</strong><br>
          </p>
        </div>
